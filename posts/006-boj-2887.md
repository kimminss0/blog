...
![일직선상으로 정렬된 1차원 공간의 정점들](/assets/images/006/img1.png){style="max-height: 60px;"}
...
![각 성분에 대해 정렬된 3차원 공간의 정점들](/assets/images/006/img2.png){style="max-height: 300px; max-width: 70%;"}
...
![subgraph](/assets/images/006/img3.png){style="max-height: 400px; max-width: 90%;"}
